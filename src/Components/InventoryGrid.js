...
// Initialize a state to track checked brands
      ...
      <div class="car-area grid bg py-120">
         ...
         <input
          ...
          <button type="submit">
            ...
            <input class="form-check-input" cheked type="checkbox" id="brand"
          ...
          checked={selectedBrands.includes('Toyota')}
            ...
            />
            <label class="form-check-label" for="brand8">Toyota</label>
            </div>
            </li>
            </ul>
            </div>
            ...
            <a class="car-sort-grid active" href="/inventoryGrid"><i class="far fa-grid-2"></i></a>
            <a class="car-sort-list" href="/inventoryList"><i class="far fa-list-ul"></i></a>
            </div>
